...
<body>
    ...
    <ul>
        ...
        // // $content = null;
        // foreach ($result as $row) {
        //     if ($row->country == null) $row->country = $row->label;
        //     $options = array_merge(array('href' => $row->country), $ad);
        //     // $content = null;
        //     echo "<$row->label".tag_options($ad).">".htmlspecialchars($row->country)."</$row->label>\n";
        // }
        // ?>
    </ul>
